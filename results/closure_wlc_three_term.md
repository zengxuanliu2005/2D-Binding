...
|---|---|---|---|---|---|---|
| rigid | 84.60 | 9.154 | 12.00 | -7.867 | -1.064 | +0.128 |
| semi | 8.18 | 7.964 | 12.00 | -7.867 | +0.295 | +0.803 |
| flex | 1.14 | 6.615 | 12.00 | -7.484 | +0.497 | +3.381 |

## Cross-system closure (k_B T)

| pair | ΔΔF_t | ΔΔF_rot | ΔΔF_conf | ΔΔF_sum | target | gap | closed |
|---|---|---|---|---|---|---|---|
| flex−rigid | +0.383 | +1.561 | +3.253 | **+5.197** | **+3.56** | +1.637 | +146% |
| semi−rigid | +0.000 | +1.359 | +0.675 | **+2.034** | **+2.68** | -0.646 | +76% |
| semi−flex | -0.383 | -0.202 | -2.577 | **-3.163** | **-0.90** | -2.263 | +351% |

## Bootstrap uncertainty (n = 200 frame-level resamples)

| pair | ΔΔF_t | ΔΔF_rot | ΔΔF_conf | ΔΔF_sum | target |
|---|---|---|---|---|---|
| flex−rigid | +0.383 ± 0.000 | +1.592 ± 0.029 | +3.256 ± 0.029 | **+5.231 ± 0.043** | +3.56 |
| semi−rigid | +0.000 ± 0.000 | +1.378 ± 0.030 | +0.675 ± 0.006 | **+2.053 ± 0.031** | +2.68 |
| semi−flex | -0.383 ± 0.000 | -0.215 ± 0.026 | -2.580 ± 0.031 | **-3.178 ± 0.044** | -0.90 |
